...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Lost Memories Team'],
			['FZ_Green',		'fz_green',		'Manager/Charter\nOwner Of Lost Memories',						'https://www.youtube.com/channel/UC-S3o7n-fMVFhV_h4Cn3xjQ',	'444444'],
			['SgTheJoker',		'sgthejoker',		'Coder/Co-manager',						'https://www.youtube.com/channel/UCSMtEmj-A3L7HgoBiaKaqXA',	'F73838'],
			[''],
			['Psych Engine Team'],
